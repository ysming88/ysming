...
<body>
<form method="post" id="WriteBlogForm" action="<%=path%>/updateblogServlet">
    <div id="layout">
        <header class="writeBlogHeader" id="writeBlogHeader">
            <div id="manageDiv1">
                ...
                <input class="title" value="${title}" type="text" id="title" name="title"/>
                <input hidden type="text" value="${id}" name="id">
                <input hidden type="text" value="${writer}" name="writer">
        ...
        <div class="editormd" id="test-editormd">
            <textarea form="WriteBlogForm" class="editormd-markdown-textarea" name="test">${content}</textarea>
        </div>
    </div>
</form>
